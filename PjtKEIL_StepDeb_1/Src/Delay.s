...
VarTime	dcd 0
	EXPORT VarTime ; on rend la variable globale 
...
Delay_100ms proc
		...
		ldr r1,=TimeValue 
		str r1,[r0] ; r0 = TimeValue à l'adresse VarTime
		
BoucleTempo	
		ldr r1,[r0]  ; r1 = valeur de VarTime				
						
		subs r1,#1 ; r1 = VarTime - 1
		str  r1,[r0] ; on met à jour la valeur sotckée à l'adresse VarTime 
		bne	 BoucleTempo
